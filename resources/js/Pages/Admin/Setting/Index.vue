    ...
    <DashboardLayout>
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-700">
                ...
                <!-- Add Category Form -->
                <form @submit.prevent="addCategory" class="flex flex-col sm:flex-row gap-4 mb-6">
                    <div class="flex-1">
                        <input 
                            type="text" 
                            v-model="form.name" 
                    ...
                    <button 
                        ...
                        class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg flex items-center justify-center transition-colors disabled:opacity-50"
                    >
                ...
                <div class="space-y-3">
                    ...
                    >
                        ...
                        <button 
                            ...
                            class="text-gray-500 hover:text-red-500 p-1 rounded-md transition-colors lg:opacity-0 lg:group-hover:opacity-100"
